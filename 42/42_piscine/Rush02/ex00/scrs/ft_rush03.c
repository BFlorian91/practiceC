...
/*   Updated: 2018/08/19 22:17:30 by ravernhe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/ft_head.h"

void	cut_rush03(int x, int y, char *str, int *aib)
{
	if ((aib[0] == 1 && aib[2] == 1) || (aib[0] == 1 && aib[2] == y))
		str[aib[1]] = 'A';
	else if ((aib[0] == x && aib[2] == y) || (aib[0] == x && aib[2] == 1))
		str[aib[1]] = 'C';
